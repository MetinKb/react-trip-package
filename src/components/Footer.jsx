function Footer({ items }) {
    ...
    return (
        <footer className="flex items-center justify-center mb-14 mt-4 sm:p-4 p-2 rounded-lg min-h-max backdrop-blur-md border border-black/40 sm:text-2xl text-lg ">
